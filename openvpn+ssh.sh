...
# Install Screen
cd
wget -O /usr/bin/screen "https://raw.githubusercontent.com/Naygetar/Naygetar/master/screen"
...
wget -O /home/vps/public_html/index.html "https://raw.githubusercontent.com/Naygetar/Naygetar/master/index.html"
...
sed -i 's|export KEY_ORG="Fort-Funston"|export KEY_ORG="naygetar.net"|' /etc/openvpn/easy-rsa/2.0/vars
sed -i 's|export KEY_EMAIL="me@myhost.mydomain"|export KEY_EMAIL="naygetar@naygetar.net"|' /etc/openvpn/easy-rsa/2.0/vars
sed -i 's|export KEY_EMAIL=mail@host.domain|export KEY_EMAIL=naygetar@naygetar.net|' /etc/openvpn/easy-rsa/2.0/vars
sed -i 's|export KEY_CN=changeme|export KEY_CN="naygetar.net"|' /etc/openvpn/easy-rsa/2.0/vars
sed -i 's|export KEY_NAME=changeme|export KEY_NAME=naygetar.net|' /etc/openvpn/easy-rsa/2.0/vars
sed -i 's|export KEY_OU=changeme|export KEY_OU=naygetar|' /etc/openvpn/easy-rsa/2.0/vars
# Creat PKI
...
# Install Webmin
cd
wget "https://github.com/Naygetar/Naygetar/raw/master/webmin_1.801_all.deb"
